...
class MasterNet(PlainNet.PlainNet):
    def __init__(self, argv=None, opt=None, num_classes=None, plainnet_struct=None, no_create=False,
        ...
        if use_se is None:
            if module_opt is not None:
                ...
                use_se = False
        plainnet_struct = 'SuperConvK3BNRELU(3,16,2,1)SuperResIDWE1K7(16,40,2,40,1)SuperResIDWE1K7(40,64,2,64,1)SuperResIDWE4K7(64,96,2,96,5)SuperResIDWE2K7(96,224,2,224,5)SuperConvK1BNRELU(224,2048,1,1)'
        self.num_classes = 2048
        self.last_channels = 2048
        super(MasterNet, self).__init__(argv=argv, opt=opt, num_classes=num_classes, plainnet_struct=plainnet_struct,
        ...
        if block_cfg is None:
            stage_planes = [16, 40, 64, 96, 224, 2048]  #0.25 default  #[16, 16, 40, 72, 152, 288]
    ...
    def extract_stage_features_and_logit(self, x, target_downsample_ratio=[8, 16, 32]):
        stage_features_list = []
        ...
        for block_id, the_block in enumerate(self.block_list):
            ...
            if dowsample_ratio in target_downsample_ratio:
    ...
    def forward(self, x):
        ...
        output = extract_stage_features_and_logit(x)
