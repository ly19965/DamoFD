...
def get_select_student_channels_list(out_channels):
    #the_list = [out_channels * 3, out_channels * 2.5, out_channels * 2, out_channels * 1.5, out_channels * 1.25]
    the_list = [out_channels * 2.5, out_channels * 2, out_channels * 1.5, out_channels * 1.25, out_channels]
    #the_list = [out_channels * 3, out_channels * 2.5, out_channels * 2, out_channels * 1.5, out_channels * 1.75,
    #            out_channels * 2.25]
                #out_channels
