...
plainnet_struct='SuperConvK3BNRELU(3,56,2,2)SuperResK1K3K1(56,80,2,40,5)SuperResK1K5K1(80,112,2,32,5)SuperResK1K3K1(112,168,2,16,4)SuperResK7K7(168,256,2,8,1)'
model = dict(
    type='SCRFD',
    backbone=dict(
        type='MasterNet',
