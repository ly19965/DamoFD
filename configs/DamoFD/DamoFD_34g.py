...
plainnet_struct='SuperConvK3BNRELU(3,56,2,2)SuperResK1K3K1(56,224,2,80,5)SuperResK1K3K1(224,488,2,40,6)SuperResK1K3K1(488,624,2,72,4)SuperResK1K7K1(624,816,2,24,3)'
model = dict(
    type='SCRFD',
    backbone=dict(
        type='MasterNet',
